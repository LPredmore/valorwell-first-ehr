...
const SignupChampva: React.FC<SignupChampvaProps> = ({
  ...
  // This field is for UI flow control only, not saved to database
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <p className="text-sm text-gray-500 italics-mt-4">We understand that this is your SSN. And although we do not necessarily agree with them using this as their patient identifier, we do have to follow their process. The only way to verify your coverage is to have this.</p>
        
        <Separator className="my-4" />
        
        {/* This field is only used for UI navigation, not saved to database */}
        <FormFieldWrapper 
        ...
        {showDisclaimer && (
          <div className="bg-gray-50 p-4 rounded-md border border-gray-200 mt-2">
            ...
            {/* This checkbox is only for UI validation, not saved to database */}
            <FormField 
              control={form.control} 
