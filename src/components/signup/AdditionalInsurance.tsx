    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        <FormFieldWrapper
          ...
          name="additionalInsuranceCompany"
        ...
        <FormFieldWrapper
          control={form.control}
          name="additionalInsurancePlanType"
        ...
        <FormFieldWrapper
          control={form.control}
          name="additionalInsuranceSubscriberName"
        ...
        <FormFieldWrapper
          control={form.control}
          name="additionalInsuranceSubscriberRelationship"
        ...
        <DateField
          control={form.control}
          name="additionalInsuranceSubscriberDob"
          label="Subscriber Date of Birth"
        />
        
        <FormFieldWrapper
          control={form.control}
          name="additionalInsuranceGroupNumber"
          label="Group Number"
          type="text"
        />
        ...
        <FormFieldWrapper
          control={form.control}
          name="additionalInsurancePolicyNumber"
          label="Policy Number"
          type="text"
        />
