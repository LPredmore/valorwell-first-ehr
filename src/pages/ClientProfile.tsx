  ...
  const fetchClientData = async () => {
    try {
      ...
      setClientData({
        ...
        // Client specific data
        preferred_name: client.client_preferred_name || '',
        date_of_birth: client.client_date_of_birth || '',
        age: client.client_age ? String(client.client_age) : '',
        gender: client.client_gender || '',
        gender_identity: client.client_gender_identity || '',
        phone: client.client_phone || '',
        state: client.client_state || '',
        time_zone: client.client_time_zone || '',
        treatment_goal: client.client_treatment_goal || '',
        minor: client.client_minor || '',
        referral_source: client.client_referral_source || '',
        status: client.client_status || 'Active',
        assigned_therapist: client.client_assigned_therapist || '',
        
        // Insurance data - Primary
        insurance_company_primary: client.client_insurance_company_primary || '',
        insurance_type_primary: client.client_insurance_type_primary || '',
        policy_number_primary: client.client_policy_number_primary || '',
        group_number_primary: client.client_group_number_primary || '',
        subscriber_name_primary: client.client_subscriber_name_primary || '',
        subscriber_relationship_primary: client.client_subscriber_relationship_primary || '',
        subscriber_dob_primary: client.client_subscriber_dob_primary || '',
        
        // Insurance data - Secondary
        insurance_company_secondary: client.client_insurance_company_secondary || '',
        insurance_type_secondary: client.client_insurance_type_secondary || '',
        policy_number_secondary: client.client_policy_number_secondary || '',
        group_number_secondary: client.client_group_number_secondary || '',
        subscriber_name_secondary: client.client_subscriber_name_secondary || '',
        subscriber_relationship_secondary: client.client_subscriber_relationship_secondary || '',
        subscriber_dob_secondary: client.client_subscriber_dob_secondary || '',
        
        // Insurance data - Tertiary
        insurance_company_tertiary: client.client_insurance_company_tertiary || '',
        insurance_type_tertiary: client.client_insurance_type_tertiary || '',
        policy_number_tertiary: client.client_policy_number_tertiary || '',
        group_number_tertiary: client.client_group_number_tertiary || '',
        subscriber_name_tertiary: client.client_subscriber_name_tertiary || '',
        subscriber_relationship_tertiary: client.client_subscriber_relationship_tertiary || '',
        subscriber_dob_tertiary: client.client_subscriber_dob_tertiary || ''
      });
    } catch (error) {
      ...
      if (isNewClient) {
        ...
        const { error: updateError } = await supabase
          ...
          .update({
            ...
            email: clientData.email,
            client_preferred_name: clientData.preferred_name,
            client_date_of_birth: clientData.date_of_birth,
            client_age: clientData.age ? parseInt(clientData.age) : null,
            client_gender: clientData.gender,
            client_gender_identity: clientData.gender_identity,
            client_phone: clientData.phone,
            client_state: clientData.state,
            client_time_zone: clientData.time_zone,
            client_treatment_goal: clientData.treatment_goal,
            client_status: 'Active',
            client_minor: clientData.minor,
            client_referral_source: clientData.referral_source,
            
            // Insurance data - Primary
            client_insurance_company_primary: clientData.insurance_company_primary,
            client_insurance_type_primary: clientData.insurance_type_primary,
            client_policy_number_primary: clientData.policy_number_primary,
            client_group_number_primary: clientData.group_number_primary,
            client_subscriber_name_primary: clientData.subscriber_name_primary,
            client_subscriber_relationship_primary: clientData.subscriber_relationship_primary,
            client_subscriber_dob_primary: clientData.subscriber_dob_primary,
            
            // Insurance data - Secondary
            client_insurance_company_secondary: clientData.insurance_company_secondary,
            client_insurance_type_secondary: clientData.insurance_type_secondary,
            client_policy_number_secondary: clientData.policy_number_secondary,
            client_group_number_secondary: clientData.group_number_secondary,
            client_subscriber_name_secondary: clientData.subscriber_name_secondary,
            client_subscriber_relationship_secondary: clientData.subscriber_relationship_secondary,
            client_subscriber_dob_secondary: clientData.subscriber_dob_secondary,
            
            // Insurance data - Tertiary
            client_insurance_company_tertiary: clientData.insurance_company_tertiary,
            client_insurance_type_tertiary: clientData.insurance_type_tertiary,
            client_policy_number_tertiary: clientData.policy_number_tertiary,
            client_group_number_tertiary: clientData.group_number_tertiary,
            client_subscriber_name_tertiary: clientData.subscriber_name_tertiary,
            client_subscriber_relationship_tertiary: clientData.subscriber_relationship_tertiary,
            client_subscriber_dob_tertiary: clientData.subscriber_dob_tertiary
          })
        ...
        const { error: clientError } = await supabase
          ...
          .update({
            ...
            client_assigned_therapist: clientData.assigned_therapist,
