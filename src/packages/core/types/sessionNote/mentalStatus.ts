...
export const mentalStatusSchema = z.object({
  ...
  attitude: z.string().min(1, "Attitude is required"),
  behavior: z.string().min(1, "Behavior is required"),
  speech: z.string().min(1, "Speech is required"),
  affect: z.string().min(1, "Affect is required"),
  thoughtProcess: z.string().min(1, "Thought process is required"),
  perception: z.string().min(1, "Perception is required"),
  orientation: z.string().min(1, "Orientation is required"),
  memoryConcentration: z.string().min(1, "Memory/concentration is required"),
  insightJudgement: z.string().min(1, "Insight/judgement is required"),
  mood: z.string().min(1, "Mood is required"),
});

export type MentalStatusFormData = z.infer<typeof mentalStatusSchema>;
