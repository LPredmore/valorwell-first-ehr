...
export const formatDateTime = (date: any, format?: string, timeZone?: string) => import('@/utils/timeZoneService').then(m => m.TimeZoneService.formatDateTime(date, format, timeZone));
