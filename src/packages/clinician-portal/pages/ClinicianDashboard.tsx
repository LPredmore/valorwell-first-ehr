...
import VideoChat from '@/packages/core/components/video/VideoChat';
import { formatTimeZoneDisplay } from '@/packages/core/utils/time';
import { AppointmentsList } from '@/packages/core/components/dashboard/AppointmentsList';
import { SessionDidNotOccurDialog } from '@/packages/core/components/dashboard/SessionDidNotOccurDialog';
import { useTimeZone } from '@/packages/core/contexts/TimeZoneContext';
import { Skeleton } from '@/packages/ui/skeleton';
import { GoogleCalendarIntegration } from '@/packages/calendar/components/GoogleCalendarIntegration';
import { SessionNoteTemplate } from '@/packages/forms/components/templates/SessionNoteTemplate';
import { useAppointments } from '../hooks/useAppointments';
import type { ClinicianDashboardProps } from '../types';
